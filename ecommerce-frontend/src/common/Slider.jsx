                ...
                <section id="home-section" class="hero">
                    <div class="home-slider owl-carousel owl-loaded owl-drag">
                        <div class="owl-stage-outer">
                            <div class="owl-stage" style={{ transform: 'translate3d(-3038px, 0px, 0px)', transition: 'all 0s ease 0s', width: 9116 }}>
                                <div class="owl-item cloned" style={{ width: 1519.2 }}>
                                    <div class="slider-item js-fullheight" style={{ height: 275 }}>
                                ...
                                <div class="owl-item active" style={{ width: 1519.2 }}>
                                    <div class="slider-item js-fullheight" style={{ height: 275 }}>
                                        <div class="overlay"></div>
                                        <div class="container-fluid p-0">
                                            <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
                                ...
                                <div class="owl-item" style={{ width: 1519.2 }}>
                                    <div class="slider-item js-fullheight" style={{ height: 275 }}>
                                        <div class="overlay"></div>
                                        <div class="container-fluid p-0">
                                            <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
